...
**Regla de ADMISIÓN (anti-teatro)**: cada regla/reflejo cita su gate (linter) o es `[HONOR]` por defecto — el linter solo mecaniza caps/huérfanas/desync/skills/archiveDir; el resto de §G.4 es honor. No fingir mecanización donde no la hay.
