...
| §80 | 2026-06-12 — M6 acuerdo de pago POR DEUDA (directiva Daniel; resuelve pregunta 1): vencimiento efectivo en aging (paridad 3/3) + herencia condicional en correcciones + UI v15 + detector acuerdosLargos + verif. experta 16 agentes (12 fixes) + SALVEDAD de Daniel registrada (plan de cuotas = siguiente diseño) — cierre pendiente de PR | 1183 |
---
