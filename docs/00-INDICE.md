...
| §156 | 2026-06-29 — **Rediseño "primera cara"** (Diseño/UI · W-11: arquitecto+comité×4+Gemini+mockup+gate NAVEGADOR REAL). Daniel: hero enorme/mucho texto/no comercial; tops con mucho espacio; 2 buscadores en colecciones. **Gemini corrigió al comité** (NO dark-stage="Frankenstein"; NO acortar-para-asomar=fast-fashion). **HERO ✅ DESPLEGADO**: foto-héroe real clara (`images/hero.jpeg`→`hero-*` avif72/webp88/2200w) dirigida-por-imagen, texto izquierda/oscuro + velo blanco + 2 CTAs + microcopy confianza; locator+firma (Kary Mendoza) a la derecha; object-position 18% (no corta cabeza); CMS intacto; SW v56. **Pend (TODO-61)**: tops compactos + dedupe buscador colecciones. Crudo→bóveda. [OPUS-4.8] | 2179 |
