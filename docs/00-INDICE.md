...
| §131 | 2026-06-27 — **Inventario v3 (TODO-40 F1) DESPLEGADO a prod**: B4 admin (enum3+visibilidad+cantidad CF-only) + B5 SSG/cliente (filtra privadas+estado derivado+guard vacío) + B6 coherencia. Daniel mergeó (#378/#379); 9 piezas de prueba borradas; reglas v3 + functions (`crearPedido`/`ajustarStock`/`cambiarTipoPieza`) DESPLEGADAS. 213/213 reglas. L-59. [OPUS-4.8] | 1884 |
...
| §133 | 2026-06-27 — **Evaluación integral de marca** (12 págs+8 comps+32 piezas+vivo+comité 5 lentes): arreglos seguros (reseñas inventadas eliminadas en vivo · footer 3 enlaces rotos · "sin precio"→`priceLabel` · slug oculto = TODO-45 ✅) + backlog TODO-44/47-51 (riesgo SIC). v42 `51c5655`. [OPUS-4.8] | 1906 |
