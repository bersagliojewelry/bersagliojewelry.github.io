# 00a — ÍNDICE SINÁPTICO · HISTÓRICO (§1–§115) — shard de rango de `00-INDICE.md`

> **Hija de `00-INDICE.md`** (range-shard, ADR §140). Mapa § → línea de
> `docs/99-HISTORIAL-ADR.md` para los ADRs **§1–§115** (eras V7 · CRM Fase 3 ·
> Fase M-acuerdos · CMS · carga app-like). Los ADRs **§116+** (era visibilidad/
> comercio) y el **enrutamiento semántico** viven en la madre `00-INDICE.md`.
>
> **Cómo usarlo** (regla anti-saturación): busca aquí el § + su línea →
> `Read docs/99-HISTORIAL-ADR.md offset=<línea> limit=~150`. NUNCA leas el historial completo.
...
> **Madre: `docs/00-INDICE.md`** (enrutamiento semántico + ADRs §116+). Un ADR NUEVO
> se indexa en la MADRE; esta hoja histórica solo crece cuando se archiva otro rango
> viejo (futuro `00b` por rango, §G.5). NUNCA leer el historial completo (offset/limit).
