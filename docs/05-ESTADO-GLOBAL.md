...
| **Cache version vigente** | `bersaglio-v70` (`public/sw.js`; SW↔05 OK; admin `APP_VERSION v34`). v70 = stepper no salta validación (gate A.9); v69 = anti-flash CMS horneado (§163); v68 = POS precio-0→por-peso. Detalle → TODO-65. |
