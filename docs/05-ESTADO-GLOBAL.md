...
| **Cache version vigente** | `bersaglio-v67` (`public/sw.js`; SW↔05 OK; admin `APP_VERSION v33`). v67 = auditoría de cierre Fable (LCP real hero-*.avif + A.2b shipping fresco + C.2 guard + login es); v66 = plan Fable Bloques A-E. Detalle → TODO-65. |
