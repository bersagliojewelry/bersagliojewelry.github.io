...
| **Cache version vigente** | `bersaglio-v35` (`public/sw.js`; verificado SW↔05). Último bump: **correcciones Daniel (§123)**: "Prefiero dejar mis datos" abre **form flotante** en la ficha (modal con la pieza enlazada → guarda lead sin navegar) + home muestra **9 destacadas** (cap 9, guard admin) + contacto: canales DEBAJO del form. (v34 = WhatsApp directo §120; v33 = grilla/recos §119.) `APP_VERSION` = criterio de deploy. |
