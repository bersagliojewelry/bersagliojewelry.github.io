...
| **Cache version vigente** | `bersaglio-v48` (`public/sw.js`; verificado SW↔05; admin `APP_VERSION v29`). Último bump: **§142 fix LQIP** — blur-up DESACTIVADO en imágenes de PRODUCTO (sangraba el placeholder borroso tras fotos transparentes; editorial lo conserva). (§141 = carrusel de ficha; §138/§139 = web; v43 = voz §134-§137.) `APP_VERSION` = criterio de deploy. |
