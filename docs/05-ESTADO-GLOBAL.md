...
| **Cache version vigente** | `bersaglio-v79` (`public/sw.js`; SW↔05 OK; admin `APP_VERSION v41`). v79 = F2.1 UI POS adjuntar cliente (banner+cola+modal, flag `config/identidad.activo`). (Historial de bumps → ADRs.) |
