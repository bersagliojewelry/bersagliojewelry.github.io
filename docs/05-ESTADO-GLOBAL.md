...
| **Cache version vigente** | `bersaglio-v25` (`public/sw.js`). Bump por §105 (fix "zoom/asentamiento" feo en recarga — `reveal.js` asienta sin animar lo visible). v24 = §104 F1 LQIP (ya en prod, PR #306). Indicador `APP_VERSION` en el sidebar = criterio de deploy. |
