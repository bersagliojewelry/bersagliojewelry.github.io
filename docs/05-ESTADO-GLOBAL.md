...
- 🟢 **PLAN ÚNICO ERP v4 (TODO-68**, spec `2026-07-04-plan-unico-erp-v4`) = roadmap vigente: F1 Pedidos&Logística → F2 POS completo → F3 Inventario → carril D → F4-F6. **F1 COMPLETO ✅ (§165-§168)**: puente + código BJ-XXXX-XXXX + CORE (TABLA + fix P0 arqueo + UI operable + gate E2E) + domicilio local cobrado (§168). **Sigue F2 POS** (sesión de caja). Pend no-gate: push A.6. **GATE vivo: precios reales + monitorear 1ª APPROVED.**
