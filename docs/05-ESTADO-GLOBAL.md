...
| **Cache version vigente** | `bersaglio-v77` (`public/sw.js`; SW↔05 OK; admin `APP_VERSION v40`). v77 = B5c fixes post-gate (reponer turnoId · opId perezoso); v76 = UI caja/bóveda F2.0 B5b-1; v75 = domicilio local cobrado. |
