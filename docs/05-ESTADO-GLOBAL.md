...
| **Cache version vigente** | `bersaglio-v72` (`public/sw.js`; SW↔05 OK; admin `APP_VERSION v35`). v72 = módulo Pedidos F1-PUENTE (TODO-68); v71 = gracias con estado real + comprobante (§164); v70 = stepper sin salto (gate A.9). |
