...
| **Cache version vigente** | `bersaglio-v85` (`public/sw.js`; SW↔05 OK; admin `APP_VERSION v45`). v85 = auditoría Antigravity SEO (hidratación sin skeleton `window.__BJ_CATALOG`+`hydrateFromBake` · copy verdad-de-marca, fuera superlativo falso). v84 = TODO-74 skeleton. Historial → ADRs. |
