...
| **Cache version vigente** | `bersaglio-v66` (`public/sw.js`; SW↔05 OK; admin `APP_VERSION v32`). v66 = plan Fable Bloques A-E (checkout hardening + admin robustez + POS/fiscal + hero LCP en SHELL_ASSETS); v65 = fix login A0. Detalle → TODO-65. |
