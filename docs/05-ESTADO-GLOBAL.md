...
| **Cache version vigente** | `bersaglio-v17` (`public/sw.js`). Bump por CMS cero-ficción (purga el films/social viejo cacheado con demo). Indicador `APP_VERSION` en el sidebar = criterio de deploy. |
