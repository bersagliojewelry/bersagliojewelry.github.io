...
| **Cache version vigente** | `bersaglio-v68` (`public/sw.js`; SW↔05 OK; admin `APP_VERSION v34`). v68 = POS precio-0→por-peso; v67 = auditoría de cierre Fable (LCP real + A.2b + C.2 guard); v66 = plan Fable A-E. Detalle → TODO-65. |
