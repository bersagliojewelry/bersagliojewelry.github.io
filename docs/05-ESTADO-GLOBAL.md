...
| **Cache version vigente** | `bersaglio-v74` (`public/sw.js`; SW↔05 OK; admin `APP_VERSION v37`). v74 = UI F1-CORE Pedidos operable + POS requiere-envío; v73 = código público BJ-XXXX-XXXX (§166); v72 = F1-PUENTE. |
