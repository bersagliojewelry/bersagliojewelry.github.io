...
| **Cache version vigente** | `bersaglio-v90` (`public/sw.js`; SW↔05 OK; admin `APP_VERSION v50`). v90 = F-IA-2 B2 (Clientes directorio ⇄ Cartera cobro). v89 = B1 pestañas "Negocio y equipo". v88 = rail v2 (§182). Historial → ADRs. |
