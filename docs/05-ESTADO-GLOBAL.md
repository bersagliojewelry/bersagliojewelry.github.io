...
| **Cerebro** | 🧠 template v1.0.0 (canon) · **kernel v1.1** (`brain-check.mjs` byte-idéntico ×3 + manifest + `archiveDir`; ADR §56 2026-06-09) · **cerebros INDEPENDIENTES** (cars §171/§172) · skills 77 catalogadas (4 de gobernanza versionadas en `skills/`) · ⏳ GC tres palancas (CLAUDE.md+10+30 sobre cap ↗; 30→shard `31-LECCIONES-FIRESTORE` = TODO-27) · skill `caza-bugs` (§90) + INSTALACION→1.1.0 tracked (checklist v6 en cars). |
