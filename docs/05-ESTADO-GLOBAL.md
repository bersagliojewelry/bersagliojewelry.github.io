...
| **Cache version vigente** | `bersaglio-v97` (`public/sw.js`; SW↔05 OK; admin `APP_VERSION v53`). **v97 = fix PII GA4 (§189)**. v96 = SEO A3 Journal indexable (§187). v95 = Journal CMS colocación (reglas journalValid **DEPLOY MANUAL**). v94 = Journal visual. v93 = F-IA-2 B5. Historial → ADRs. |
