...
| **Cache version vigente** | `bersaglio-v29` (`public/sw.js`; verificado SW↔manager↔05). Último bump: A3 menú admin instantáneo desde rol cacheado (TODO-33; v28 = admin sin VT heredadas). Indicador `APP_VERSION` = criterio de deploy. |
