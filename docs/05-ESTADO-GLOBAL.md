...
| **Cache version vigente** | `bersaglio-v32` (`public/sw.js`; verificado SW↔05). Último bump: **ficha "Carta Gemológica" REFINADA** (TODO-34, guía Claude Design handoff) — gema = octágono talla-esmeralda con lustre radial (antes hexágono plano) + specs SIN líneas + valores Cormorant 22px + marcadores octágono dorado + certificación pastilla (v31 = rediseño ficha base; v30 = ficha dinámica/tallas). Indicador `APP_VERSION` = criterio de deploy. |
