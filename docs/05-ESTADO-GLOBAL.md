...
| **Cache version vigente** | `bersaglio-v30` (`public/sw.js`; verificado SW↔manager↔05). Último bump: detalle de pieza — ficha técnica dinámica + cero-demo (sin Origen/Entrega/descripción falsos) + tallas reales (campo admin `sizes`) + badge/ref/CTA (TODO-34; v29 = menú admin instantáneo). Indicador `APP_VERSION` = criterio de deploy. |
