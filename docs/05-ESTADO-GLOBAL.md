...
| **Cache version vigente** | `bersaglio-v64` (`public/sw.js`; SW↔05 OK; admin `APP_VERSION v31` — ⚠️ sin bump desde v31, revisar E.2 del plan). v64 = fixes país/borrado-fotos/caché-CMS; v63 = checkout. Detalle → TODO-63. |
