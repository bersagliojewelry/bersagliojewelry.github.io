...
| **Cache version vigente** | `bersaglio-v94` (`public/sw.js`; SW↔05 OK; admin `APP_VERSION v53`). v94 = Journal pulido visual (letra capital cover 54px alineada + resumen 1-col; `.hj-trio` centrado anti-tarjeta-sola). v93 = F-IA-2 B5 (Salud legible + "Cierre de mes" in situ + microcopy GLOBAL; SOLO texto). v92 = B4 (Bandeja única). v91 = B3 ("Hoy" pulso $). Historial → ADRs. |
