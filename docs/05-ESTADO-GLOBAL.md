...
|---|---|
| **Build** | 🟢 Vite VERDE (~14s). Panel v2 en prod (§50-§53); norte = spec maestra v3. Suite local verde: acuerdos 18/18 (A8 §87) · estado 24 · paridad byte 4 · saldo 12 · reconciliación 9 · rules 144 (emulador, Java) · backup 7 · singleton-CMS 35. ⚠️ Preview headless no pinta dinámico (L-05) → verificar en `dev`/deploy. |
