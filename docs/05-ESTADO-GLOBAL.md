...
| **Cache version vigente** | `bersaglio-v82` (`public/sw.js`; SW↔05 OK; admin `APP_VERSION v44`). v82 = hardening export CSV (anti formula-injection, comité F2.2). v81 = Auditoría de caja (F2 TODO-69). v80 = Mostrador reactividad money-safe. (Historial de bumps → ADRs.) |
