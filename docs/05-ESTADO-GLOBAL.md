...
| **Cache version vigente** | `bersaglio-v87` (`public/sw.js`; SW↔05 OK; admin `APP_VERSION v47`). v86-v87 = [FABLE-5] fix traslado-duplicado + auditoría anti-fugas (§181). v85 = auditoría Antigravity SEO. Historial → ADRs. |
...
- 🟣 **FABLE 5 ACTIVO hasta el 12-jul** (cuota %). Interinato Opus #2 CERRADO. **§181 DESPLEGADO** (fix traslado-duplicado + auditoría anti-fugas, functions+rules+Pages, SW v87). **`limiteCajon=$500k`** (Kary). **1ª APPROVED real ✅** — del gate solo resta **precios reales**. Skills nuevas/v2 → §181.7.
