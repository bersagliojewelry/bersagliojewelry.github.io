...
| **Cache version vigente** | `bersaglio-v34` (`public/sw.js`; verificado SW↔05). Último bump: **TODO-37 B0.5 — WhatsApp directo** (§120): los CTAs de la ficha abren WhatsApp con la pieza escrita (helper puro `waLink`, fuente única del número) + evento GA4 `whatsapp_click`; formulario = vía secundaria (captura CRM hasta B2). (v33 = grilla/recos §119; v32 = ficha §118.) `APP_VERSION` = criterio de deploy. |
