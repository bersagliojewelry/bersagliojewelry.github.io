...
| **Cache version vigente** | `bersaglio-v81` (`public/sw.js`; SW↔05 OK; admin `APP_VERSION v43`). v81 = Auditoría de caja (F2 TODO-69: vista owner solo-lectura, línea de tiempo en vivo por turno). v80 = Mostrador reactividad money-safe (ventas EN VIVO + panel optimista). (Historial de bumps → ADRs.) |
