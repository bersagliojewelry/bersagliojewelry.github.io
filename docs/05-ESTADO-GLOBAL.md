...
| **Cache version vigente** | `bersaglio-v42` (`public/sw.js`; verificado SW↔05; admin `APP_VERSION v26`). Último bump: **Eval marca §133** — footer con enlaces de colección VÁLIDOS (3 rotos arreglados: aretes/dijes/argollas-de-matrimonio), etiqueta "sin precio" UNIFICADA (catálogo/ficha/relacionados leen `piece.priceLabel`; muere "— Editorial —"/"Bajo consulta"), slug OCULTO en panel de piezas (TODO-45a). (v41 = bruto/neto + export contador §130.) `APP_VERSION` = criterio de deploy. |
