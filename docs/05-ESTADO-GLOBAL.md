...
|---|---|
| **Build** | 🟢 Vite VERDE (~5s). Panel v2 en prod (§50-§53); norte = spec maestra v3. Suite local verde (rules 248 · cartera 26 · teso 31 · caja 38 · y las puras). ⚠️ Preview headless no pinta dinámico (L-05) → verificar en `dev`/deploy. |
| **Cache version vigente** | `bersaglio-v98` (`public/sw.js`; SW↔05 OK; admin `APP_VERSION v58`). v98 = F-TESORERÍA B2-B5 (**DESPLEGADO 2026-07-24**; V17 el 25 solo bumpeó APP_VERSION: `SHELL_ASSETS` no precachea JS/HTML del panel). |
