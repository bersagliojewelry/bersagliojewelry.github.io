...
| **Cache version vigente** | `bersaglio-v51` (`public/sw.js`; SW↔05 OK; admin `APP_VERSION v30`). Último bump: **§145 fix gestos del visor de zoom** — pinch + arrastrar-para-mover ahora funcionan (manejo unificado pointer events) + quitada la casilla "Etiqueta de precio" del admin. (v50 = candado §144; v49 = visor §143; v48 = LQIP §142.) `APP_VERSION` = criterio de deploy. |
