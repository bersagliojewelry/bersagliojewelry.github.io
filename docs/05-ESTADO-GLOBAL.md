...
| **Cache version vigente** | `bersaglio-v31` (`public/sw.js`; verificado SW↔05). Último bump: **rediseño ficha de pieza "Carta Gemológica"** (TODO-34) — grilla de cuadritos → UN panel de cristal con gema protagonista + specs agrupadas en 2 columnas (Calidad/El metal/Origen y entrega) + sello GIA; adaptativo/cero-demo (v30 = ficha dinámica/tallas reales; v29 = menú admin instantáneo). Indicador `APP_VERSION` = criterio de deploy. |
