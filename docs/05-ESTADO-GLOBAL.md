...
| **Cache version vigente** | `bersaglio-v93` (`public/sw.js`; SW↔05 OK; admin `APP_VERSION v53`). v93 = F-IA-2 B5 (Salud legible + "Cierre de mes" in situ + microcopy GLOBAL; SOLO texto). v92 = B4 (Bandeja única). v91 = B3 ("Hoy" pulso $). v90 = B2 (Clientes ⇄ Cartera). Historial → ADRs. |
