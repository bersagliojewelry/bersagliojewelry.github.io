...
| **Cache version vigente** | `bersaglio-v15` (`public/sw.js`). Bump por Fase M / M6 (acuerdo de pago por deuda). Indicador `APP_VERSION` `v15` en el sidebar (criterio de deploy). |
