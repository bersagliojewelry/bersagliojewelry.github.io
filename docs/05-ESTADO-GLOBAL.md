...
| **Cache version vigente** | `bersaglio-v80` (`public/sw.js`; SW↔05 OK; admin `APP_VERSION v42`). v80 = Mostrador reactividad money-safe (ventas recientes EN VIVO `onUltimasVentasChange` + panel de caja optimista al abrir). v79 = F2.1 UI POS adjuntar cliente. (Historial de bumps → ADRs.) |
