...
| **Cache version vigente** | `bersaglio-v28` (`public/sw.js`; verificado SW↔manager↔05). Último bump: admin desactiva View Transitions heredadas (parpadeo/InvalidStateError, TODO-33, cazado en vivo). Indicador `APP_VERSION` = criterio de deploy. |
