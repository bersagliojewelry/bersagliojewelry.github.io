...
| **Branch activa** | `Desarrollo` ≡ `main` (PR #221 mergeado). **M1 §72 DESPLEGADO en prod 2026-06-10** (reglas + índice COLLECTION_GROUP `solicitudes`, verificado). Prod `main` (hasta #221) DESPLEGADO: rediseño + CRM + Fase R + Panel v2 + Morosos §51 + F5 §52 + F4 §53 + frente D §64. **11 functions** nodejs22 vivas (§64 + §65 DESPLEGADOS, verificado `functions:list`); `.co` HTTP 200. `git fetch` antes de afirmar (L-26). |
