...
| **Cache version vigente** | `bersaglio-v22` (`public/sw.js`). Bump por §100 (cero-demo: fondos CSS demo removidos en Nosotros/Home + fix flash + móvil). Indicador `APP_VERSION` en el sidebar = criterio de deploy. |
