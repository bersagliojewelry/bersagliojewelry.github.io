...
| **Cache version vigente** | `bersaglio-v73` (`public/sw.js`; SW↔05 OK; admin `APP_VERSION v36`). v73 = código público de pedido BJ-XXXX-XXXX (§166); v72 = módulo Pedidos F1-PUENTE (TODO-68); v71 = gracias estado real (§164). |
