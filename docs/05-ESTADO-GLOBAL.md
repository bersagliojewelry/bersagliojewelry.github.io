...
- 🟣 **INTERINATO #4 — lo ejecuta `OPUS-5`** (Fable agotó cuota el 27-jul; el relevo no ocurrió). B0→B6 ✅. Reglas vivas: marca `[OPUS-5]` + footer · ⚠️ **auditar por AMBOS marcadores** — los commits de B2·B3·B4 llevan `[OPUS-4.8]` heredado por error y NO se reescriben (ya pusheados) · el titular audita B0→B6 + el comité de F-COMPRAS al volver (§158/§161). **Gate de Daniel: Kary NO usa hasta confiabilidad 100%.** Narrativa → §192-§194.
