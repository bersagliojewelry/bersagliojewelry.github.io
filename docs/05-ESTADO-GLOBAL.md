...
| **Cache version vigente** | `bersaglio-v47` (`public/sw.js`; verificado SW↔05; admin `APP_VERSION v29`). Último bump: **§141 carrusel de ficha** — galería con >1 imagen = flechas izq/der + contador + puntos + swipe (reemplaza miniaturas). (§139 = copy comercial; §138 = 16 destacadas+isla+etiqueta; v43 = voz §134-§137.) `APP_VERSION` = criterio de deploy. |
