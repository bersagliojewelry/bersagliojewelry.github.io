...
| **Cache version vigente** | `bersaglio-v50` (`public/sw.js`; SW↔05 OK; admin `APP_VERSION v29`). Último bump: **§144 candado de calidad** en el visor de zoom — el zoom no supera el tamaño REAL de la foto (no pixela las temporales §132; completo con las finales). (v49 = §143 visor+flechas sutiles; v48 = LQIP §142; v43 = voz §134.) `APP_VERSION` = criterio de deploy. |
