...
| **Cerebro** | 🧠 template v1.0.0 · `brain:check` SANO · skills: **77 catalogadas, 6 instaladas** user-level · **nuevo 2026-06-08 (TODO-16)**: neuronas `42-LEGAL`+`60-WORKFLOWS`, skills `comite-expertos`/`legal-colombia`/`arquitecto-software`, regla `CLAUDE §3.7` (calidad/comité automático). |
