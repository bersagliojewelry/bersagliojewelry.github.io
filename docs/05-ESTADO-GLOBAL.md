...
| **Branch activa** | `Desarrollo` ≡ `main` (PR #221 mergeado). **M1 §72 + M2a-1b §73 DESPLEGADOS en prod 2026-06-10** (reglas + índice `solicitudes`; anulacionValida ensanchada para el par de corrección). Prod `main` (hasta #221) DESPLEGADO: rediseño + CRM + Fase R + Panel v2 + Morosos §51 + F5 §52 + F4 §53 + frente D §64. **11 functions** nodejs22 vivas (§64 + §65 DESPLEGADOS, verificado `functions:list`); `.co` HTTP 200. `git fetch` antes de afirmar (L-26). |
