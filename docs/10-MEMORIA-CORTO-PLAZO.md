...
> 2026-07-10 · **[FABLE-5] Auditoría B0 (limpio) + decisiones D1-D7 CERRADAS** (detalle→spec §0.7). Para B2-B5: D2 Bandeja única · D3 Hoy sin "Consultas recientes" · D4 Cierre-de-mes in situ en Salud · D5 B4 reusa `aprobaciones.js`+`aprobarEventoCaja`. Opus ejecuta sin preguntar.
