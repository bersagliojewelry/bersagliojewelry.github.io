...
| TODO-49 | **Legal e-commerce** (prereq Wompi). §157.x ✅ DESPLEGADO: retracto/reversión/garantía/SIC/datos + IVA + identidad real (Kary=comerciante) + consentimiento (LEGAL-10 code+tests 11/11). Consejo ×2 integrado; abogado OMITIDO (Daniel). Términos+Privacidad REESCRITOS con proceso real ✅ DESPLEGADO (§157.11-12: sin info falsa/fluff; Ley 2439 reembolso 15d cal; pago Wompi+transferencia; envíos; garantía 12m + legal; comité ×3 integrado). FAB por zonas ✅. **RESTA**: repaso externo (Antigravity+ChatGPT sobre texto nuevo) + confirmar garantía 12m (Daniel) + **encender Wompi** (deploy functions + llaves Kary + precios). Detalle → `42-LEGAL §5`. | 🟡 | externos + encender |
