...
>
> **2026-06-12 (noche) · M4 CONSTRUIDO COMPLETO** → **ADR §78** (todo el detalle ahí; CRUDO de la verif. 22-agentes en bóveda). **Para CERRAR (§78.7)**: PR de Daniel → verificar v13 + sección en prod vía navegador → marcar §78.8 · primer corte real = 1 de julio 03:50 (verificar `cortes/2026-06` o correr `generarCorte`).
