...
>
> **▶️ SESIÓN 2026-06-28 — ficha: visor de zoom (§143-§146) [OPUS-4.8]:** §143 visor+flechas (otra sesión; TODO-55 ✅, cierra §141/§142) · §144 candado de calidad · §145 unificación de gestos a pointer events + quitada casilla precio admin · **§146 modelo de toque intuitivo** (Daniel: "1 click cierra / arrastrar no mueve"): evidencia Playwright mostró que pinch/pan YA funcionaban en v51 pero el TAP LIMPIO cerraba → ahora **tocar la JOYA acerca, tocar el MARGEN cierra**. SW v52 · APP_VERSION v30. **DESPLEGADO** → verif. live Playwright + **Daniel debe RECARGAR la ficha** (el SW cachea). → ADRs §143-§146.
...
> **§143-§146 (2026-06-28):** ficha — visor de zoom (§143 otra sesión, cierra §141/§142) + candado no-upscale (§144) + unificación de gestos pointer events (§145) + casilla precio admin removida (§145) + **modelo de toque intuitivo: joya=acercar, margen=cerrar (§146)**. SW v52. Evidencia Playwright: pinch/pan OK desde v51; el tap limpio cerraba → §146. Post-mortem: re-trabajo por local stale → §144.7/TODO-22. → ADRs §143-§146.
