...
| TODO-58 | **Buscador por código** (spec `2026-06-29-buscador-codigo`; buscador+link, catálogo+inicio). **Slice 1 HECHO ✅**: `data.getByCode`+`codigo-util.js` (puro, test 5/5)+`buscador-codigo.js`+CSS en CATÁLOGO. **Pend (NEXT=slice 2: link `/p/<código>` SSG stubs OG)**: inicio · `Ref.` ficha · 404. | 🟡 | slice 2 (link) |
...
| TODO-60 | **Buscador inteligente** (Daniel 2026-06-29): tomar lo BUENO del buscador del index de **Altorra Cars** (NO espejo) + **filtro en TIEMPO REAL** en colecciones. Requiere ver repo Altorra. Eleva TODO-58. | 🔲 | ver Altorra |
