...
| TODO-47 | **Verdad de marca (riesgo SIC)** — confirmar con Kary qué es REAL y retirar lo no comprobable (equipo, certificaciones, cifras, envíos, horario). Financiación ✅ (solo Wompi 4 cuotas 0%). → §133.2(A) · `[[feedback_no_demo_en_index]]`. 🔴 **SUBE**: claims YA PÚBLICOS en el GBP (**"garantía de por vida"**, certificados, platino) = vinculante ante la SIC → **§190.5**. | 🔲 | Kary |
...
> 2026-07-17 · **[OPUS-4.8] ENTREGABLE → ALTORRA** (skill SEO/AEO/GEO): `.../2026-07-17-aprendizajes-SEO-AEO-GEO-para-skills.md` — **SSoT**: corrige 3 claims del borrador 07-10 + §3.7 (FAQPage muerto + meta-lección "las features del SERP mueren").
