...
> ✅ **Cerrados**: **TODO-58 (§154 buscador por código + links `/p/`)** · TODO-59 (§153) · TODO-56/55/51/52/53/54/44/45/46 · TODO-40+32 → ADRs/`99`. Pend Daniel: precios + fotos IA. (TODO-60 buscador inteligente sigue abierto: autocomplete.)
