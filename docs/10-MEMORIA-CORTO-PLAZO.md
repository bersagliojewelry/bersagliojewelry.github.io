...
| TODO-49 | **Legal e-commerce** (prereq Wompi). §157.x ✅ DESPLEGADO: retracto/reversión/garantía/SIC/datos + IVA + identidad real (Kary=comerciante) + consentimiento (LEGAL-10 code+tests 11/11). Consejo ×2 integrado; abogado OMITIDO (Daniel). **EN CURSO**: reescritura §03/§04/§05 con proceso real (Ley 2439 reembolso 15d cal; pago Wompi+transferencia; envíos; garantía 12m). **RESTA encender**: deploy functions + llaves Kary + precios. Detalle → `42-LEGAL §5`. | 🟡 | reescritura + encender |
