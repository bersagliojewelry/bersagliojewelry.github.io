...
>
> **▶️ ESTADO — tren M0→M6 EN PROD (§80.8, PR #234)** · **DISEÑO ACUERDOS DE PAGO SELLADO** (comité 7 agentes → spec `2026-06-12-acuerdos-de-pago-design.md`; CRUDO en bóveda). **Para avanzar**: (1) respuestas de Daniel a P1/P2/P3 de la spec §3; (2) Consejo Externo (prompt listo en bóveda `…consejo-externo-acuerdos-prompt.md` — Daniel lo pega en Gemini); (3) integrar ambas → ADR §81 → construir slices 1-5 de la spec §1.10. Kary prueba TODO al final.
