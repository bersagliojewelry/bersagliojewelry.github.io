...
| TODO-62 | **Pinch-zoom móvil iOS — pantallazos BLANCOS al regresar.** FIX DESPLEGADO (§156.17): glass SÓLIDO en móvil (`backdrop-filter:none !important` ≤680px + `--glass-tint`↑.88 + `.bj-world translateZ(0)`); desktop intacto, sin cache bump. **PEND: confirmar en iPhone 13 Pro Max de Daniel** — ¿se fueron los pantallazos? ¿ok el glass más sólido del móvil? → L-62 / §156.17. | 🟡 | confirmar iPhone |
