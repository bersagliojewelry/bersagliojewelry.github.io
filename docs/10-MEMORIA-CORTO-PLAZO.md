...
>
> **🧭 FOCO = PLAN ÚNICO ERP v4 (TODO-68, Daniel 2026-07-04: "un solo sistema, tú defines el orden")** — SSoT: spec `2026-07-04-plan-unico-erp-v4`. **F1 COMPLETO: PUENTE ✅ (§165) + CORE ✅ (§167, backend `994776a` + UI `d12be6f` + gate E2E 3 flujos EN PROD 2026-07-06)**. Restan F1-extras que NO gatean: push FCM A.6 · badge sidebar. **EN CURSO: F2.0 caja/bóveda — backend B0-B4 ✅ + B5a wrappers onCall ✅ (superficie llamable completa; L-72 ya resuelto en d244d77, verificado). PRÓXIMO B5b UI (POS caja + vista Bóveda owner + panel aprobaciones) → B5c SW bump + deploy manual + gate Chrome + ADR. B5b/c = frontend/deploy → sesión fresca.** Precios NO bloquean; monitorear 1ª APPROVED sigue vivo. `[[project_comercio_pagos]]`
