...
| TODO-60 | **Buscador inteligente** (Daniel 2026-06-29): **filtro en vivo código O nombre en colecciones HECHO ✅** (puros `normalizar`/`piezaMatchea`/`filtrarCatalogo`, test 10/10; debounce, `?q=`, Enter→pieza, sin tildes). **Pend**: lo bueno del index de **Altorra Cars**. | 🟡 | ver Altorra |
