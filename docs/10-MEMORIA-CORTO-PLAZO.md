...
>
> **▶️ ESTADO — tren M0→M6 EN PROD (§80.8, PR #234)** · **EN CURSO: diseño PLAN DE CUOTAS / ACUERDOS DE PAGO** (comité ×3 + red-team; síntesis → spec + preguntas cerradas a Daniel + prompt de Consejo Externo). Kary prueba TODO al final.
