...
> **Avance B1 (detalle → ADRs §122-§130)**: pasos 1-3 + COP **MERGEADOS a prod**; **pasos 4a-6 §128-§130** → **Mostrador OPERABLE + export contador** (crear · confirmar pago · anular/VOID · arqueo Z · bruto/neto CSV; 15/15 integración + 207/207 reglas + 5/5 fiscal). CFs `crearPedido`/`confirmarPago`/`anularPedido`/`cierreCaja` + reglas DESPLEGADAS. **➡️ SIGUIENTE: paso 7 `catalogo.json` a CDN** · decisión 4b apartados (TODO-39).
> _**PEND merge Daniel**: §128-§130 (`ba6da22`,`1362a32`,`f3c9060`). ⚠️ **Pruebas en vivo DIFERIDAS al final del plan+rediseño** (Daniel §130.4; NO probar pieza por pieza — build+tests por commit = red de seguridad). Gotcha dev L-58._ Cola: TODO-39 · TODO-33 · TODO-35.
