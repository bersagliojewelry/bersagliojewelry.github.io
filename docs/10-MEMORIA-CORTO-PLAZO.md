...
>
> **Sesiones §133-§139 (2026-06-27) — CATÁLOGO + WEB, DESPLEGADO:** voz de marca de las 32 (§134 nombre/desc → §135 cálido → §136 tipo [TODO-53/54/51 ✅] → §137 significado; 3 capas, vía Gemini+verif) + ajustes web §138/§139 (16 destacadas + botón "Ver más piezas" + isla solo index + etiqueta tarjeta "Consultar precio" + ficha sin precio sin rótulo). Lección Workflow: datos grandes EMBEBIDOS, no por `args`. → ADRs §133-§139 + bóveda. `[[feedback_copy_marca_profundidad]]`
> **§140 (cars-operador) + §141 (2026-06-27):** §140 range-shard del índice (00→00+00a, kernel shard-aware ×4; 00 a 9.6k) ✅. §141 galería de ficha = **carrusel** (con >1 imagen: flechas izq/der + contador + puntos + swipe; reemplaza miniaturas; `setGalleryIdx` swap directo sin re-render). Build verde, SW v47, DESPLEGADO. ⚠️ verif. live pendiente (headless no pinta Firestore). → ADRs §140/§141.
