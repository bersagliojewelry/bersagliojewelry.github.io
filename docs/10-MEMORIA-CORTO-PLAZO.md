...
> **Sesión §138 (2026-06-27 tarde) — 4 AJUSTES WEB (Daniel), DESPLEGADO:** 16 destacadas (+7 marcadas; ajuste 15→16 = columnas de 4 exactas) + botón al final de la franja · isla "Atajos" SOLO en index (verif. live) · **etiqueta única "Precio a consultar"** (`priceDisplay` SSoT en `core/format.js`; elimina "Cotización"/"Consultar precio"; 32 piezas con `priceLabel=""`). Build+test:sidebar verdes. SW v45 · APP_VERSION v28. Detalle → ADR §138.
