...
>
> **▶️ RETOMAR AQUÍ**: escribir el **plan del Bloque 1 (Fundamentos: datos + roles/claims + reglas + tests)** con `writing-plans`; luego construir por bloques (1 Fundamentos → 2 Saldo CF → 3 Panel Kary → 4 App vendedora responsive → 5 Migración → 6 Reportes). NO toca producción hasta verificar.
>
