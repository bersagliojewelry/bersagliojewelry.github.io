...
| TODO-40 | **Escasez Fase B** (Daniel 2026-06-26): inventario **multi-unidad real** (POS decrementa `cantidad` en vez de marcar vendida toda la pieza) → habilita "Solo quedan N"/"¡Última unidad!" HONESTOS. Hoy todo es pieza única → Fase A ("Pieza única"/"Por encargo", honesta) va con 7b/7c. Spec `2026-06-26-b1-paso7 §11`. | 🔲 | decisión Daniel + inventario |
