...
> 2026-07-10 · **[OPUS-4.8] F-IA-2 B5 ✅ → CODE-COMPLETE (SW v93/APP v53)** commit `31d63ee`. Salud legible ("Avisos del sistema", semáforos con nombre humano) + "Cierre de mes" reescrito IN SITU (D4, ids intactos, acta con estado-vacío honesto §0.5) + microcopy GLOBAL vía **workflow blindado** read-only (11 págs, 45 candidatos → aplicados los de jerga clara, encolados money-direction/contador → spec notas B5). SOLO texto: cero lógica. build + 81/81 tests. ⏳ funcional-con-sesión → deploy+login. **Fable audita `[OPUS-4.8]`** (cola spec §6.1). `[[feedback_opus_interino]]`
> 2026-07-10 · **[OPUS-4.8] F-IA-2 B0·B1·B2·B3·B4 ✅** (detalle+commits → spec checklist): B1 params unificados (SW v89) · B2 split Clientes/Cartera (v90) · B3 "Hoy" pulso $ (v91) · B4 Bandeja única + badge rail (v92). ⏳ funcional-con-sesión.
