...
| TODO-49 | **Legal e-commerce** (prereq Wompi). §157.x ✅ DESPLEGADO: retracto/reversión/garantía/SIC/datos + IVA + identidad real (Kary=comerciante) + consentimiento (LEGAL-10 code+tests 11/11). Consejo ×2 integrado; abogado OMITIDO (Daniel). Términos+Privacidad REESCRITOS con proceso real ✅ DESPLEGADO (§157.11-12: sin info falsa/fluff; Ley 2439 reembolso 15d cal; pago Wompi+transferencia; envíos; garantía 12m + legal; comité ×3 integrado). FAB por zonas ✅. Repaso externo ×2 (Antigravity+ChatGPT) INTEGRADO §157.13 (FATAL Art.43 cláusula transporte → corregido; +disponibilidad/características/garantía-proc/PQR-horario). **Términos = comité ×3 + 2 externos, verificados vs Ley 1480+2439+Dto.587+1581.** **RESTA**: confirmar garantía 12m (Daniel) + **encender Wompi** (deploy functions + llaves Kary + precios). Detalle → `42-LEGAL §5`. | 🟡 | confirmar 12m + encender |
