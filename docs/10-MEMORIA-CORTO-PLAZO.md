...
| TODO-76 | **F-IA-2 + DEPURACIÓN de plataforma (INTERINATO Opus 4.8)** — spec exacta: `specs/2026-07-10-f-ia-2-DISENO.md`. **B0 inventario página-por-página (marco §0.5 + veredictos del titular: eliminar Kardex/Pendientes, fusionar Sistema en 2 items, acta→Salud)** → B1 Parámetros (6 pestañas +Usuarios) → B2 Split Clientes/Cartera → B3 "Hoy" → B4 Bandeja (+badge) → B5 Salud legible + microcopy global. CERO functions/dinero nuevo; gates Chrome holísticos; checklist con evidencia. `[[feedback_reorganizar_no_es_depurar]]` | 🔲 | Opus (interinato) |
