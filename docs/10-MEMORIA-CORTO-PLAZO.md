...
>
> **B5 COMPLETO** (D6·V1·V18·V17·D9 + cuadre 3:30 vigilando las cuentas). **SIGUE: B6** (rompimiento adversarial) → cierre de F-TESORERÍA. ⚠️ **E2E de D9 espera la 1ª cuenta REAL de Kary** (prod tiene 0 a propósito, V21): verificado hasta donde prod permite + 26 tests.
>
