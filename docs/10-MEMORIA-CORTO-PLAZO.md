...
| TODO-24 | **🔴 PRIORIDAD #1 — index 100% gestionable** (Daniel 2026-06-20, "encima de todo"): cerrar gaps del CMS de contenido → **Films/videos** (`createResourceAdmin`, enlace+miniatura) · **Social/redes** (curado manual) + cablear `home/films.js`·`home/social.js` a Firestore; menores Servicios+Marquee. Resto del index YA cubierto (auditoría en foco). Decisiones Daniel: enlace+miniatura · curado manual | 🟡 EN CURSO | construir (Claude) |
