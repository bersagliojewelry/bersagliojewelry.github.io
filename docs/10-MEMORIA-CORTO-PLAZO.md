...
| TODO-63 | **Rediseño UX del checkout (DISEÑO → mockup-first, W-11)** — Daniel 2026-06-30 probando en vivo: (1) **selector país bandera+código** (Colombia +57…; LatAm + USA/Canadá/Venezuela + Europa) junto al tel/WhatsApp (sin código WhatsApp no sirve); (2) **tipo de envío**: nacional (recoge en tienda / domicilio) vs internacional (NO cobro online → WhatsApp; espeja elegibilidad Wompi); (3) tarjetas "Cómo quieres avanzar" salen **enormes** en desktop → acotar; (4) **Widget Wompi sale enorme** → responsive (es componente de Wompi: evaluar tamaño controlable vs redirect `checkout.wompi.co`). Va con mockup. | 🔲 | diseño/mockup |
...
>
> **2026-06-30 (post-go-live · consistencia, cache v61):** pruebas live → quitado "IVA incluido" (No resp. IVA) en carrito/ficha/cart-drawer; nota de envío real + FAQ alineadas a Términos §02/§04; botón "Pagar ahora"→"Procesando…" (anti doble-clic). Build verde. Revelado **rediseño UX checkout → TODO-63** (va con mockup). ⚠️ FAQ financiación (`nosotros-defaults`:146) = posible demo → TODO-47.
