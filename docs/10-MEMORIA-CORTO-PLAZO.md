...
> 2026-07-04 (2ª sesión, parte 2): **PLAN ÚNICO ERP v4 DEFINIDO + AMPLIADO (TODO-68)** — todo el detalle vive en la spec (SSoT): comité ×3 unánime (CRUDO → bóveda) + estudio ALTORRA (agente) + decisiones D-1/D-2/D-5 de Daniel + caja completa/impresión térmica/antirrobo-bóveda/radar 8b/§11 modelos. Modelo: sigue FABLE; interinato Opus = fallback probado (§158/§161).
