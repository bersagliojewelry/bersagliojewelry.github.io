...
>
> **2026-06-29 (§156 "primera cara" — §156.1–.14 DESPLEGADO):** hero inmersivo+bajo, tops compactos, buscador unificado/compacto, marquee y código muerto fuera, **acceso "Asesoría privada"** (cristal marfil + ícono WhatsApp esmeralda + serif, tras 30% scroll — reemplazó la isla de agua; flujo W-11 ×2, el consejo CORRIGIÓ al comité: fuera avatar/punto), cookie banner PC legible. Todo en prod, sin cache bump. Detalle → ADR §156.x + CRUDO bóveda. **ABIERTO**: (a) **iOS a confirmar en iPhone** (§156.15) — zoom (auroras off + blurs bajados); eyebrow ahora OCULTO en móvil + velo más ligero (lavaba "tallado") + línea vertical del logo quitada; esquinas ✅. (b) **TODO futuro**: botón "Hablar con el Atelier" en la ficha bajo el precio.
