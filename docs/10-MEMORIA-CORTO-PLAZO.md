...
> 2. **🛡️ Semana 1 del plan §57** (bóveda `plan-operacion-robustecimiento-2026-06.md`): frenos de gasto (alertas de presupuesto + endurecer reglas de forms + identificar origen de las 3.6K inválidas) · **gemelo** (2º proyecto Firebase: aula Kary + banco de pruebas + restore) · backup diario + restore probado (TODO-15) · 2FA Google+GitHub (Daniel dijo SÍ) · kill-switch doc · talonarios/arqueo (Kary). **⏸️ DIAN/factura electrónica PAUSADA por Daniel** (solo si Kary la pide; ventas = "tirilla" comprobante interno rotulado "no es factura electrónica"; supuesto planeación ~$120-150M/año < umbral $183M; detalle → bóveda LEGALES). Decisiones 1-9 respondidas ✅ (política cartera v1 propuesta · contrato dueños = entregable pendiente).
