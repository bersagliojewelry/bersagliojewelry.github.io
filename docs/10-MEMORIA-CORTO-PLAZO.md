...
| TODO-47 | **Verdad de marca (riesgo SIC)** — confirmar con Kary qué es REAL. **✅ garantía de por vida** (Kary confirmó → alineada en Términos §191) · **✅ certificados de autenticidad** (reales) · **✅ reseñas familiares** (clientes reales, se quedan). **SIGUE sin confirmar**: "platino" (resp. GBP) · "oro por peso" (resp. GBP) · **cifras del home** (`editorial`: 40+ años / 5000+ piezas — el default decía 12+/800+; salto grande, riesgo SIC) · equipo/envíos/horario. → §190.5 · §191.7 · `[[feedback_no_demo_en_index]]`. | 🔲 | Kary |
...
> 2026-07-17 · **[OPUS-4.8] Auditoría GSC + GBP** (TODO-35 · detalle → spec visibilidad + §190). GSC: 9 indexadas / 27 "rastreada sin indexar" (juicio de VALOR). GBP 85★5,0 → **las 85 NO están en la web → TODO-48 SUBE** (espacio existe: `nosotros.js §10 resenas.items` hide-when-empty; colección `reviews`+reglas hechas, SIN consumir; ⚠️ NO `aggregateRating` con reseñas de Google). Palancas: reseñas en web · GBP fresco · precios · enlaces.
> 2026-07-17 · **[OPUS-4.8] Garantía DE POR VIDA → §191** (cierra Hallazgo A §190.5). Kary confirmó de por vida → Términos §05 subió de 12 meses a de por vida (defectos de fabricación; Ley 1480 + exclusiones intactas; alcance vía AskUserQuestion). + fix "sin límites" en home (Firestore). Certificados=reales, reseñas familiares=clientes reales → sin cambio. **TODO-47 sigue**: platino · oro-por-peso · cifras home 40+/5000+.
> 2026-07-17 · **[OPUS-4.8] B2 GBP ✅ 85/85 → §190** (11 respondidas; autorizó Daniel). 2 hallazgos → **(a) 🔴 claims vinculantes ya públicos (TODO-47)** · (b) 🟠 reseñas del círculo cercano = política de Google. Detalle → §190.
