...
>
> **🚦 Próximo (decide Daniel)**: correr el **prompt de Gemini** (preparado, R1/R3) sobre TODO-33 → luego **medición** (baseline navegador real) → Fase 0. Después: contenido real web (TODO-07) · App Check (TODO-14). **Regla**: `arquitecto-software` SIEMPRE · `[[feedback_workflows_acotados]]`.
