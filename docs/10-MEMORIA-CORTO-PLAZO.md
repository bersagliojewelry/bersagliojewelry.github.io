...
>
> **▶️ §108-§111 EN PROD (saga caché/blur cerrada salvo 1 merge).** §108 F1/F3 + §109 + **§111 SWR siteContent** + **migración LQIP** (§110.4, 8 backfilled) desplegados; **§111 VALIDADO en prod** (Daniel: modelo mental exacto "blur en frío, instantáneo desde caché" + extensión Chrome ✅ consola/transiciones/2ª-carga). Detalle → ADR §108-§111 (+110.4, +111.8) y L-50(EXT)/L-52. **Único pendiente: Daniel mergea `f8f79ec`** (111.8 — blur en catálogo/wishlist/detalle; §108.14 solo cubría el Home; degrada solo, carrito/drawers omitidos=caché). SA key de bersaglio quedó en Descargas → Daniel la borra/revoca. **Boot nueva sesión**: §111(.8) + §110.4 + §108.13-.16 + L-50(EXT)/L-52.
>
