...
> - **SIGUE (continuar el plan)**: F3 (barandas: aviso al salir sin publicar · "Publicado ✓") · `global` (datos de contacto compartidos ~5 comp.) · `hideWhenEmpty` general · usuarios/SPA P5. **Pendiente GC**: ADR WYSIWYG (F1+F2) + P3.5 a `99` (aún sin consolidar).
>
