...
> 2026-07-17 · **[OPUS-4.8] Auditoría GSC + GBP** (TODO-35 · B2 · skill `maps-gbp-local`). **GSC**: 9 indexadas / **27 "rastreada: actualmente sin indexar"** = juicio de VALOR de Google, NO bloqueo técnico (las rastrea a diario; casi todas `/pieza/*`) · 2 noindex · 0 404. Sitemap **REENVIADO** (leído 10jul=37; hoy 52). Producto: 17 no válidas por falta `price` → **NO bloquea indexación, solo el rich snippet** (docs Google); review/rating opcionales → **NO inventar**. CWV sin datos. **L**: "solicitar indexación" pieza-a-pieza NO sirve contra "rastreada sin indexar" (ya la rastreó). **GBP**: verificado 100%, cat "Joyería", **85 reseñas ★5,0** pero **mayoría SIN RESPONDER** (4/5 muestra) = **palanca #1 GRATIS**; perfil sin tocar 6 sem (pide fotos/posts mensuales); reseñas mixtas es/en → **turista anglo** (¿SEO solo-es deja plata?); **las 85 NO están en la web** → TODO-48 SUBE. ⚠️ NO `aggregateRating` con reseñas de Google (3º, contra política). **A4 geo ✅** (10.4251642,-75.5492068 · `/g/11z12mf6kd`) horneado, deploy `d1015f2`. Palancas: responder reseñas · reseñas en web · GBP fresco · precios · enlaces.
