...
> 2026-07-17 · **[OPUS-4.8] A4 ✅ CERRADO → §188** (og:type=product, prod verificado-vivo dos puntas; + guard SP-5.3). **⚠️ FAQPage RETIRADO**: su rich result murió 07-may-2026 (doc oficial) → schema solo = teatro SEO; la FAQ **visible** es CONTENIDO y choca con TODO-47 → **decide Daniel** (verificable hoy = `js/core/envio-config.js`). Meta-lección portada → ALTORRA §3.7 + skill. **Frescura**: `05` decía §184 → real **§187+**.
