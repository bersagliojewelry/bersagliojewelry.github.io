...
| TODO-35 | **Visibilidad SITE-WIDE** (SEO·AEO·GA4·GSC·Maps·SSG). **AUDITORÍA 6-frentes 2026-07-10** → spec `2026-07-10-visibilidad-seo-aeo-geo-DISENO.md` (47 findings · 3 cubetas). **A1 ✅** titles/meta keyword-first (deploy `43e0666`). GSC verificado (authuser=3; sitemap enviado; piezas EN COLA; colecciones solicitada). SIGUE: A2/A3 (categorías+blog) · B2 GBP (ranking local) · A4 geo/FAQ · A5 feed. Shopping ⏳ precios. Pend previo: eventos `generate_lead`/`contact` + 2º flujo GA. 🔑 Google authuser=3. | 🟢 | A2/A3/B2 |
...
> 2026-07-10 · **[OPUS-4.8] VISIBILIDAD SEO/AEO/GEO — auditoría 6-frentes + A1** → spec `2026-07-10-visibilidad-seo-aeo-geo-DISENO.md` (SSoT; 47 findings, 3 cubetas). Verificado EN VIVO: **GSC OK** (authuser=3; sitemap enviado; **piezas EN COLA "descubierta sin indexar" — NO hay bug**, dominio nuevo indexa lento). **A1 ✅** titles/meta keyword-first (deploy `43e0666`; poema visible intacto); colecciones solicitada a indexación. SIGUE: A2/A3 (categorías+blog) · B2 GBP (ranking local) · A4 geo/FAQ. Shopping ⏳ precios. Crudo `tasks/w9930xxeu.output`. `[[feedback_no_demo_en_index]]`
