...
> **(1) TODO-35 · VISIBILIDAD SITE-WIDE** — **🟢 Fases A1 (piezas indexables) + B (marca/Maps) HECHAS en `Desarrollo`, SIN desplegar** (detalle en la fila TODO-35). B usó datos reales de Daniel (NAP+IG/FB/TikTok) y corrigió los links rotos de IG/FB en vivo. Catálogo prod VACÍO (Kary recarga) → 0 piezas horneadas hoy (correcto). **Falta**: A2 colecciones+journal · C GA4(`analytics.js`)+GSC · **horarios** (Daniel) · desplegar · prompt Altorra HUB. Spec/research → bóveda `2026-06-25-*`.
