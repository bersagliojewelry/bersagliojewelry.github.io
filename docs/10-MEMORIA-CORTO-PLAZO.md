...
| TODO-44 | **Voz de marca en las 32 piezas** (§132/§133): Claude PROPONE los 32 (nombre evocador sin "Natural"/rótulo del lab · descripción de 3 movimientos · badge por gema), Daniel aprueba. Sistema completo → §133.2(B)/§133.7. Precios de prueba solo al implementar Wompi. `[[feedback_voz_de_marca_no_generico]]` · `[[feedback_flujo_diseno_mockup]]` | 🟢 | Claude propone |
...
> ✅ **Cerrados recientes**: **TODO-45 limpieza UI (slug+Editorial) ✅** + **TODO-46 escaneo integral ✅** (§133). TODO-40 inventario v3 + 32 piezas TrueLab (§131/§132, L-60). Histórico → ADRs §88-§132 + `00`/`99`. Pend operativo Daniel: precios + imágenes IA (panel v3).
