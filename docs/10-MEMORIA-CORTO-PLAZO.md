...
| TODO-76 | **F-IA-2 implementación (INTERINATO Opus 4.8)** — spec exacta con decisiones cerradas: `specs/2026-07-10-f-ia-2-DISENO.md`. Orden B1 Parámetros unificados → B2 Split Clientes/Cartera → B3 "Hoy" con dinero → B4 Bandeja aprobaciones (+badge rail). CERO functions/dinero nuevo; gates Chrome holísticos por bloque; checklist con evidencia en la spec. | 🔲 | Opus (interinato) |
> ✅ **Cerrados** (detalle → ADRs/`99`): **TODO-75 (§183 minería 5 recursos: twenty 7 principios→specs v5 · 3 técnicas Divisual · adspirer 12→meta-ads · impeccable→`33 §4` · skills-main=callejón; síntesis `mineria-recursos-2026-07-10.md`; n8n/Canva-lote PARQUEADOS)** · TODO-73 (§179 POS-pro money-model desplegado) · TODO-74 (§178 index skeleton) · TODO-72 (§177 Grupo A UX) · TODO-41 (§176 F2.2 multi-línea) · TODO-70 (§173 POS pro/caja ON) · TODO-69 (§172 caja tiempo real) · TODO-37/65/63/49/42/66/64/21/40/32 + 62-44 (rango). Pend Daniel: precios + fotos IA.
...
> 2026-07-09 · **F2.4 apartados SPEC** (W-11 completo). Detalle → spec `2026-07-09-f2-4-apartados-DISENO.md` + bóveda. Cancelación resuelta (art.43.5 → reembolso 100%+saldo-a-favor). Ver TODO-39.
> 2026-07-10 · **[FABLE-5] §181 + §182 CERRADOS Y DESPLEGADOS** (anti-fugas 4 P0 + rail v2 + plan maestro v5; detalle → ADRs). **1ª APPROVED real ✅** — gate restante: SOLO precios reales. ⚠️ Decisión pendiente Daniel+Kary: conservar la cartera migrada (runbook limpieza, spec v5 §8).
> 2026-07-10 · **[FABLE-5] TODO-75 ✅ (§183)**: minería de 5 recursos con 5 exploradores acotados + verificación propia. Adoptado: 7 principios twenty→specs v5 · 12 técnicas paid-media→`meta-ads-diagnostico` · checklist quality→`33 §4` · 3 técnicas Divisual. Parqueado: n8n (WhatsApp+reseñas) · Canva-lote. **Prompt único a ALTORRA entregado a Daniel** (copia: bóveda `2026-07-10-PROMPT-ALTORRA-sinapsis.md`).
> 2026-07-10 · **[FABLE-5] RELEVO → INTERINATO #3**: Fable al 93% de cuota; con el 7% final diseñó y cerró TODAS las decisiones de F-IA-2 en `specs/2026-07-10-f-ia-2-DISENO.md` (TODO-76, para Opus) + flag en `05` + cola del titular (auditoría interinato → F-TESORERIA → F-COMPRAS → F-REPORTES → apartados → ficha-pestañas → n8n). Pendientes de DANIEL sin cambio: precios reales (⛔ gate) · decisión cartera migrada (spec v5 §8) · consejo externo+abogado apartados (TODO-39) · pegar prompt a ALTORRA.
