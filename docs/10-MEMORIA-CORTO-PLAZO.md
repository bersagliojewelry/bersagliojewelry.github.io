...
| TODO-62 | **Gráficos en pinch-zoom (móvil/iOS)** — el CRASH se mitigó (§156.10-14), pero al hacer zoom amplio y **REGRESAR** aparecen **pantallazos BLANCOS / frames cargando** (re-rasterización de capas con `blur` en la transición). Falla en iPhone 13 Pro Max de Daniel → peor en gama media. Candidatos + plan → **ADR §156.16** (reducir/quitar más `backdrop-filter` móvil · replantear glass móvil · ¿límite WebKit?). Probar en iPhone REAL (no reproducible en Chrome desktop). Posible W-11 perf. | 🔲 | sesión fresca |
> ✅ **Cerrados**: **TODO-61 (§156 rediseño primera cara + acceso "Asesoría privada" — §156.1-16, DESPLEGADO; dead code del buscador ya limpiado en §156.10)** · TODO-60 (§155 buscador unificado) · TODO-58 (§154) · TODO-59 (§153) · TODO-56/55/51/52/53/54/44/45/46 · TODO-40+32 → ADRs/`99`. Pend Daniel: precios + fotos IA.
...
>
> **2026-06-29 (§156 "primera cara" §156.1–.16 — DESPLEGADO):** rediseño completo: hero inmersivo+bajo, tops compactos, buscador unificado/compacto, marquee y código muerto fuera, **acceso "Asesoría privada"** (cristal marfil + WhatsApp esmeralda + serif, tras 30% scroll — reemplazó la isla; flujo W-11 ×2, el consejo CORRIGIÓ al comité: fuera avatar/punto), cookie PC legible, hero móvil iOS (esquinas ✅ · eyebrow oculto · velo ligero · logo crosshair RESTAURADO visible). Todo en prod, sin bump. Detalle → ADR §156.x + CRUDO bóveda. **ABIERTO** → **TODO-62** (flashes blancos al regresar del zoom móvil, sesión fresca) + confirmaciones iOS finales de Daniel + TODO "Hablar con el Atelier" en ficha.
