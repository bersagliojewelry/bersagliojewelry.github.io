...
> definiciones `### M-NN` SOLO de `30` → allí queda el **stub-header** de cada una (M-06); el DETALLE vive aquí — salvo el de las **migradas al maestro** (M-01..M-06, M-08, M-09, M-23; lote 13), que es un stub con su puntero.
...
⇒ **Migrada al maestro** (F2 lote 13): [[BERS:M-01]] · cuerpo íntegro en `/_legacy/LECCIONES-MIGRADAS-MAESTRO.md` (raíz del repo).

### M-02: Una lección sobre estado verificable-por-comando (git/build) debe volverse GATE, no prosa [HONOR]
⇒ **Migrada al maestro** (F2 lote 13): [[BERS:M-02]] · cuerpo íntegro en `/_legacy/LECCIONES-MIGRADAS-MAESTRO.md` (raíz del repo).

### M-03: Un campo `last` de tracking nace null/baseline, nunca con fecha que finja una ejecución
⇒ **Migrada al maestro** (F2 lote 13): [[BERS:M-03]] · cuerpo íntegro en `/_legacy/LECCIONES-MIGRADAS-MAESTRO.md` (raíz del repo).

### M-04: La memoria del harness deriva en silencio (fuera de `docs/`, el linter no la cubre)
⇒ **Migrada al maestro** (F2 lote 13): [[BERS:M-04]] · cuerpo íntegro en `/_legacy/LECCIONES-MIGRADAS-MAESTRO.md` (raíz del repo).

### M-05: Edité un subsistema bajo UNA lente y lo di por bueno sin probar el camino vivo (§89)
⇒ **Migrada al maestro** (F2 lote 13): [[BERS:M-05]] · cuerpo íntegro en `/_legacy/LECCIONES-MIGRADAS-MAESTRO.md` (raíz del repo).

### M-06: El kernel acopla las definiciones `### L-NN` a `30` → shard de lecciones = stub-en-30 + detalle-en-hija (§96)
⇒ **Migrada al maestro** (F2 lote 13): [[BERS:M-06]] · cuerpo íntegro en `/_legacy/LECCIONES-MIGRADAS-MAESTRO.md` (raíz del repo).
...
⇒ **Migrada al maestro** (F2 lote 13): [[BERS:M-08]] · cuerpo íntegro en `/_legacy/LECCIONES-MIGRADAS-MAESTRO.md` (raíz del repo).
...
⇒ **Migrada al maestro** (F2 lote 13): [[BERS:M-09]] · cuerpo íntegro en `/_legacy/LECCIONES-MIGRADAS-MAESTRO.md` (raíz del repo).

### M-23: El sello "(al fecha)" del 05 caduca en silencio — REINCIDENTE (A2-§175 → §192): re-sellar no arregla el mecanismo (2026-07-18)
⇒ **Migrada al maestro** (F2 lote 13): [[BERS:M-23]] · cuerpo íntegro en `/_legacy/LECCIONES-MIGRADAS-MAESTRO.md` (raíz del repo).
