...
- **146.4 Verificación**: build verde + verif. live POST-deploy (Playwright pointer sintético en v52: tap-en-imagen → scale>1 y NO cierra; tap-en-margen → cierra; drag → pan) + Daniel en dispositivo. ⚠️ El SW cachea → Daniel debe RECARGAR la ficha (HTML network-first trae el JS nuevo; ideal Ctrl+Shift+R). [HONOR]
