...
## 2026-06-27 — §138 Ajustes web: 15 destacadas + botón al final + isla solo en index + etiqueta única de precio
...
- **138.2 #1 Destacadas 9→15 + botón inferior**: render (`js/home/featured.js` `getFeatured(15)` + `slice(0,15)`) + **tope admin** (`js/admin/piezas.js` 9→15, antes bloqueaba la 10ª) + **6 piezas marcadas featured** por variedad (Puro Albor·Ecos de Bóvedas·Cielo Sereno·Dulce Granada·Talismán del Tiempo·Clara Aurora) → 15 totales. CTA "Explorar el catálogo entero" al final de la franja (`.home-featured-foot`, centrado, `css/home.css`).
