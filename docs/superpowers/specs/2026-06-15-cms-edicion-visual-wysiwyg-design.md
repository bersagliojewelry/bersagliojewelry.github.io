...
**FALTA**: deploy + Daniel valida fidelidad desktop + sticky en vivo. **Luego**: F3 (barandas: aviso al salir sin publicar; "Publicado ✓") · `nosotros` (editor de listas P4) · `global` · imágenes P3.5. (Futuro: **toggle desktop/móvil = F4**.)
