/**
 * Bersaglio Jewelry — Featured Pieces Component V8 (Liquid Glass Aqua)
 *
 * Markup matches bersaglio.html design: glass-iridescent card with image
 * (aspect 4/5), tag chip overlay, wishlist heart top-right, padded info row
 * (eyebrow + display title + meta + price+arrow).
 *
 * Data: db.getFeatured(limit) — pieces with featured=true in admin.
...
/** Sentence-case ALL-CAPS strings coming from older Firestore docs. */
...
/** Look up the human name of a collection slug from the live admin data. */
...
/** Compose the meta line: "Esmeralda · Oro 18K". */
