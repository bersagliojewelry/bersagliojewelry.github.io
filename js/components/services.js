/**
 * Bersaglio Jewelry — Services Component V5
 * Showcase wheel layout — Phosphor Icons (light) + gema.png central
 * Updated: 4 pillars with correct brand info
 */
...
const serviceIcons = {
    ...
    /* Diseño y Fabricación a Medida — Compass light */
    ...
    /* Certificación y Garantía — Seal Check light */
    ...
    /* Taller y Mantenimiento — Wrench light */
    tools: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" fill="currentColor" aria-hidden="true">
        <path d="M224.71,79.29a6,6,0,0,0-9.42,0L176,118.59l-12.29-12.3,39.3-39.29a6,6,0,0,0-2-9.8A70,70,0,0,0,111.39,67.6L43.52,135.46a30,30,0,0,0,0,42.43l34.59,34.59a30,30,0,0,0,42.43,0l67.86-67.87A70,70,0,0,0,224.71,79.29ZM112.05,204l-34.6-34.59a18,18,0,0,1,0-25.45L145.31,76.1a58,58,0,0,1,72.53-7.94L176,110.06a6,6,0,0,0,0,8.49l17.46,17.45a6,6,0,0,0,8.49,0l41.89-41.84a58,58,0,0,1-7.94,72.53L168.05,234.55a18,18,0,0,1-25.46,0Z"/>
    </svg>`
};
