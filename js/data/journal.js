...
const _entries = [
    ...
    {
        id:            'j003',
        slug:          'certificacion-gia-que-garantiza',
        title:         '¿Qué garantiza exactamente un certificado GIA en tu gema?',
        excerpt:       'El GIA es el estándar mundial de gemología. Pero detrás del papel hay una ciencia exacta que protege tu inversión. Aquí te explicamos qué mide y por qué importa.',
        content: [
            'El Gemological Institute of America (GIA) fue fundado en 1931 y desde entonces ha establecido el lenguaje universal de la gemología. Sus certificados son aceptados por joyeros, aseguradoras y coleccionistas en todo el mundo como la referencia definitiva.',
            'Un certificado GIA para un diamante evalúa cuatro variables —las famosas "4C"— con una precisión milimétrica: Color (desde D, incoloro, hasta Z, tono amarillo visible), Clarity (de Flawless a I3), Cut (desde Excellent hasta Poor), y Carat Weight (peso expresado en fracciones de quilate).',
            'Para las esmeraldas, el proceso es diferente. El GIA evalúa color, tono, saturación, claridad y origen geográfico. Este último punto es especialmente relevante para nosotros: una esmeralda certificada de origen colombiano tiene un valor diferencial significativo en el mercado internacional.',
            'Cada pieza Bersaglio que incorpora gemas preciosas viene acompañada de su certificación correspondiente. No como formalidad, sino como garantía de que la historia que te contamos sobre tu joya está respaldada por la ciencia.',
        ],
        category:  'gemas',
        date:      '2025-01-14',
        readTime:  '4 min',
