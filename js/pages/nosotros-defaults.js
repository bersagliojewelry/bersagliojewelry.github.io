...
export const NOSOTROS_DEFAULTS = {
    ...
    hero: {
        ...
        lead:         'Nacimos con una visión clara: acercar piezas únicas a quienes aprecian la elegancia de una joya auténtica de esmeraldas y diamantes. Hoy somos la plataforma de e-commerce y atelier de joyería más grande de la región, facilitando canales virtuales de compra y atención directa en nuestra Maison del Centro Histórico de Cartagena.',
        leadItalic:   'Ofrecemos tanto colecciones exclusivas listas para entrega inmediata en todo el país a través de nuestro catálogo digital, como un servicio personalizado para co-crear piezas únicas a medida en oro de 18K.',
    ...
    atelier: {
        ...
        titleEm:     'toma forma',
        p1:          'En el corazón del Centro Histórico de Cartagena tenemos nuestra casa y showroom principal, que funciona en perfecta sinergia con nuestra boutique virtual. Aquí fabricamos cada pieza de nuestro catálogo online y atendemos de forma presencial.',
