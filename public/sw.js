...
// v98 = [OPUS-4.8] F-TESORERÍA B2: nueva página admin "Cuentas y bancos" (admin-tesoreria.html +
// tesoreria.js) + ítem en el rail Finanzas (sidebar-data.js, shell admin) → bump del shell.
